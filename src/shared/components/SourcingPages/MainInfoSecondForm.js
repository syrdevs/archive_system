...
let MainInfoSecondForm= props => {
  ...
  return (
    !!tofiConstants && <Form className="antForm-spaceBetween IndividualsMainInfo__second-form">
      <Row>
...
export default reduxForm({ form: 'MainInfoSecondForm', enableReinitialize: true })(MainInfoSecondForm);
