...
class IndividualInventories extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      inv: {
  ...
  render() {
    ...
    const { t, tofiConstants: {invNumber, invType, invDbeg, invDend, invDate1, invDate2, invDate3,
      invDeadline, caseNumber, caseDbeg, caseDend, caseNumberOfPages} } = this.props;
...
export default IndividualInventories;